...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            'App\\Controller\\Admin_controller' => 'getAdminControllerService',
            'App\\Controller\\Demo_controller' => 'getDemoControllerService',
            'App\\Controller\\User_controller' => 'getUserControllerService',
    ...
    /**
     * Gets the public 'App\Controller\Admin_controller' shared autowired service.
     *
     * @return \App\Controller\Admin_controller
     */
    protected function getAdminControllerService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\ControllerTrait.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\AbstractController.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\Admin_controller.php';
        include_once \dirname(__DIR__, 4).'\\src\\Service\\Poll_service.php';

        $this->services['App\\Controller\\Admin_controller'] = $instance = new \App\Controller\Admin_controller(new \App\Service\Poll_service(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService())));

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\Admin_controller', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\Demo_controller' shared autowired service.
     *
     * @return \App\Controller\Demo_controller
     */
    protected function getDemoControllerService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\ControllerTrait.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\AbstractController.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\Demo_controller.php';
        include_once \dirname(__DIR__, 4).'\\src\\Service\\Random_number_generator_service.php';

        $this->services['App\\Controller\\Demo_controller'] = $instance = new \App\Controller\Demo_controller(new \App\Service\Random_number_generator_service());

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\Demo_controller', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\User_controller' shared autowired service.
     *
     * @return \App\Controller\User_controller
     */
    protected function getUserControllerService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\ControllerTrait.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\AbstractController.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\User_controller.php';

        $this->services['App\\Controller\\User_controller'] = $instance = new \App\Controller\User_controller();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\User_controller', $this));
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('QTIwXcpw9w', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getCache_SystemService()
    {
        ...
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('c+CB5K9RjE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\PoolRepository' => ['privates', 'App\\Repository\\PoolRepository', 'getPoolRepositoryService', false],
        ], [
            'App\\Repository\\PoolRepository' => '?',
        ])));
    ...
    /**
     * Gets the private 'App\Repository\PoolRepository' shared autowired service.
     *
     * @return \App\Repository\PoolRepository
     */
    protected function getPoolRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\PoolRepository.php';

        return $this->privates['App\\Repository\\PoolRepository'] = new \App\Repository\PoolRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    protected function getCache_AnnotationsService()
    {
        ...
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sxumLIJ2yP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
